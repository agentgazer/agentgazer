...
# Usage: curl -fsSL https://agenttrace.dev/install.sh | sh
#
# This script:
...
install_agenttrace() {
  ...
  if [ ! -f "$LIB_DIR/lib/node_modules/agenttrace/dist/cli.js" ]; then
...
exec "$NODE" "$AGENTTRACE_HOME/lib/lib/node_modules/agenttrace/dist/cli.js" "$@"
'
...
main() {
  ...
  # Get version
  AT_VERSION="$("$RESOLVED_NODE" "$LIB_DIR/lib/node_modules/agenttrace/dist/cli.js" version 2>/dev/null || echo "unknown")"
