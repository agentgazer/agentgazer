...
export default async function DashboardLayout({
  ...
  return (
    <div className="flex h-screen bg-gray-950">
      {/* Sidebar */}
      <aside className="flex w-16 flex-col items-center border-r border-gray-800 bg-gray-950 py-4">
        {/* Logo */}
        <div className="mb-8 flex h-8 w-8 items-center justify-center rounded-lg bg-blue-600 text-sm font-bold text-white">
          AW
        </div>
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        {/* Top bar */}
        <header className="flex h-14 items-center justify-end border-b border-gray-800 bg-gray-950 px-6">
